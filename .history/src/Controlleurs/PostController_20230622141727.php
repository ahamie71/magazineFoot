...
// on doit utliser ce qu'on appele un token de securité ,  c'est une clé aleatoire et longue associé a chaque utilisateur lors de sa connexion 
//on va crée le token
// si dans la session il existe pas un tekone , on doit lui generer un  toekjn d'une manière aléatoire mais en s'assurant qu'on a moins de redondences
if(!isset($_SESSION['token'])){
   // 
  $_SESSION['token'] = md5(time()*rand(175,6))
