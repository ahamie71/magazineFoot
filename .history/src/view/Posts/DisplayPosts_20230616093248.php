...
<?php
    $user = $post->getUser(); // Supposons que $post est une instance de la classe `Post`
    $username = $user->getUsername(); // Supposons que `getUsername()` est une méthode dans la classe `User`
    ?>
                                    <?= $post->getTitle() ?>.....
                                </h1>
