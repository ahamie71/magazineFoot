...
?> 
  ...
  height: 300px">
          ...
          <form method="post" action="index.php?action=commenter&id=<?=$posts['id'];?>">
        <div class="form-group">
          <textarea class="form-control"  required="required"name="content" rows="4" placeholder="Ecriver votre commentaire.. "></textarea>
        </div>
        <div class ="form-group">
